...
/**
 * Storm Topology for Data Stream Processing System A Kafka data source is
 * required.
 * 
 * @author Tony WANG
 */
public class KafkaTopology {
	...
	public static void main(String[] args) throws Exception {
		// if args is not null, it will load indicated properties XML file
		// else it will load default XML file in the classpath

		DSPPropertyUtil.loadXMLConfig();
		...
		SpoutConfig spoutConf = SpoutConfig.fromHostStrings(hosts,
				DSPPropertyUtil.KAFKA_PARTITION_PER_HOST, "topic",
